    ...
    <div style={overlayStyle}>
      <div style={{ ...modalBase, maxWidth: 520 }}>
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 20 }}>
          <button onClick={onClose} style={{ padding: "9px 20px", border: "1px solid var(--color-border-secondary)", borderRadius: 8, background: "none", cursor: "pointer", fontSize: 13, color: "#fff" }}>Cancelar</button>
    ...
    <div style={{ maxWidth: 680 }}>
      ...
      {vista === "abrir" && (
        <div style={{ background: "var(--color-background-secondary)", borderRadius: 14, border: "1px solid var(--color-border-tertiary)", padding: 24 }}>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
            <button onClick={() => { setVista("principal"); setError(""); }} style={{ padding: "9px 18px", border: "1px solid var(--color-border-secondary)", borderRadius: 8, background: "none", cursor: "pointer", fontSize: 13, color: "#fff" }}>Cancelar</button>
      ...
      {modal?.tipo === "nueva" && (
        <div style={overlayStyle}>
          <div style={{ ...modalBase, maxWidth: 480 }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 20 }}>
              <button onClick={() => setModal(null)} style={{ padding: "9px 18px", border: "1px solid var(--color-border-secondary)", borderRadius: 8, background: "none", cursor: "pointer", fontSize: 13, color: "#fff" }}>Cancelar</button>
...
function HistorialVentas() {
  ...
  const cambiarMetodo = async (ventaId, nuevoMetodo) => {
    ...
    finally { setEditandoMetodoId(null); }
  };
                    ...
                    <tr key={v.id} style={{ borderTop: "1px solid var(--color-border-tertiary)" }}>
                      ...
                      <td style={{ padding: "8px 14px" }}>
                        {editandoMetodoId === v.id ? (
                          ...
                          <span onClick={() => v.estado === "pagada" && setEditandoMetodoId(v.id)}
